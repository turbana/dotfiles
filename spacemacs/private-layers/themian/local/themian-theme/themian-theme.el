...
(themian-with-color-variables
  (setq themian-faces-list
        `(
          ...
          (magit-diff-added (:background ,green-8))
          (magit-diff-added-highlight (:foreground ,white-1 :background ,green-9))
          ...
          (magit-diff-file-heading (:foreground ,blue-3 :weight bold))
          (magit-diff-file-heading-highlight (:inherit highlight))
          (magit-diff-file-heading-selection (:background ,unknown))
          (magit-diff-hunk-heading (:foreground ,white-3 :background ,grey-4 :slant italic))
          (magit-diff-hunk-heading-highlight (:foreground ,white-1 :background ,grey-5))
          (magit-diff-hunk-heading-selection (:background ,unknown))
          (magit-diff-lines-boundary (:background ,unknown))
          (magit-diff-lines-heading (:background ,unknown))
          (magit-diff-our (:background ,unknown))
          (magit-diff-our-highlight (:background ,unknown))
          (magit-diff-removed (:background ,red-8))
          (magit-diff-removed-highlight (:foreground ,white-1 :background ,red-9))
          ...
          (magit-popup-option-value (:background ,unknown))
          ...
          (magit-section-secondary-heading (:background ,unknown))
