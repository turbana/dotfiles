...
(defmacro themian-with-color-variables (variant &rest body)
  ...
  `(let* ((class '((class color) (min-colors 89)))
          ...
          (base-4   (if dark "#262626" "#f7eed4"))
          (base-3   (if dark "#333333" "#ece2c6"))
          (base-2   (if dark "#666666" "#d1c294"))
          (base-1   (if dark "#7f7f7f" "#baa35e"))
          (base+1   (if dark "#999999" "#958450"))
          (base+2   (if dark "#b2b2b2" "#74673e"))
          (base+3   (if dark "#cccccc" "#4c4633"))
          (base+4   (if dark "#d9d9d9" "#38362e"))
          (blue     (if dark "#7a90cc" "#334985"))
          (green    (if dark "#7acc8d" "#338546"))
          (yellow   (if dark "#b9cc7a" "#728533"))
          (violet   (if dark "#8d7acc" "#463385"))
          (orange   (if dark "#ccb67a" "#856f33"))
          (cyan     (if dark "#7ab9cc" "#337285"))
          (magenta  (if dark "#cc7ab9" "#853372"))
          (red      (if dark "#cc7a90" "#853349"))
          (blue-bg  (if dark "#334985" "#7a90cc"))
          (green-bg (if dark "#338546" "#7acc8d"))
          (yellow-bg (if dark "#728533" "#b9cc7a"))
          (violet-bg (if dark "#463385" "#8d7acc"))
          (orange-bg (if dark "#856f33" "#ccb67a"))
          (cyan-bg  (if dark "#337285" "#7ab9cc"))
          (magenta-bg (if dark "#853372" "#cc7ab9"))
          (red-bg   (if dark "#853349" "#cc7a90"))
          (diff-1   (if dark "#1c3f4a" "#90c5d5"))
          (diff-2   (if dark "#316e81" "#58a8c0"))
          (diff-3   (if dark "#071012" "#c7e2ea"))
          (diff-4   (if dark "#1c3f4a" "#90c5d5"))
          ;;;; THEMIAN-COLORS-END
          )
     (mapcar
      (lambda (config)
  ...
  (apply
   ...
   (themian-with-color-variables
     ...
     `(
       ...
       (fringe (:foreground ,base+1 :background ,base-3 :box (:line-width 1 :color ,blue)))
       ...
       (linum
        (:foreground ,base+1 :background ,base-3 :weight normal :slant italic
       ...
       (org-block-end-line (:foreground ,base+1 :slant italic))
       ...
       (org-code (:foreground ,base+4 :background ,base-2) :inherit (fixed-pitch))
