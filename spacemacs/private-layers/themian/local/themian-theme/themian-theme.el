...
(themian-with-color-variables
  (setq themian-faces-list
        `(
          ...
          (org-agenda-calendar-event (:background ,unknown))
          (org-agenda-calendar-sexp (:background ,unknown))
          (org-agenda-clocking (:background ,unknown))
          (org-agenda-column-dateline (:background ,unknown))
          (org-agenda-current-time (:background ,unknown))
          ...
          (org-agenda-dimmed-todo-face (:background ,unknown))
          ...
          (org-column (:background ,unknown))
          (org-column-title (:background ,unknown))
          ...
          (org-done (:foreground ,green-1 :weight bold))
          (org-drawer (:background ,unknown))
          (org-ellipsis (:background ,unknown))
          ...
          (org-kbd (:background ,unknown))
          (org-latex-and-related (:background ,unknown))
          (org-level-1 (:foreground ,yellow-1))
          ...
          (org-time-grid (:background ,unknown))
          (org-todo (:foreground ,orange-1 :weight bold))
          (org-upcoming-deadline (:foreground ,white-1))
          (org-verbatim (:background ,unknown))
          ...
          (spacemacs-motion-face (:foreground ,grey-1 :background ,blue-2 :weight bold))
          (spacemacs-normal-face (:foreground ,grey-1 :background ,white-2 :weight bold))
          ...
          (undo-tree-visualizer-active-branch-face (:foreground ,white-1 :weight bold))
