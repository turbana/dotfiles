...
(defmacro themian-with-color-variables (variant &rest body)
  ...
  `(let* ((class '((class color) (min-colors 89)))
          ...
          (blue     (if dark "#92b3f3" "#0c2d6d"))
          (green    (if dark "#92f3a1" "#0c6d1b"))
          (yellow   (if dark "#e3f392" "#5d6d0c"))
          (violet   (if dark "#a192f3" "#1b0c6d"))
          (orange   (if dark "#f3d292" "#6d4c0c"))
          (cyan     (if dark "#92e3f3" "#0c5d6d"))
          (magenta  (if dark "#f392e3" "#6d0c5d"))
          (red      (if dark "#f392b3" "#6d0c2d"))
          (diff-1   (if dark "#0c6173" "#5ed6ed"))
          (diff-2   (if dark "#0f758a" "#47d0eb"))
          (diff-3   (if dark "#05272e" "#a3e8f5"))
          (diff-4   (if dark "#073a45" "#8ce2f2"))
          ;;;; THEMIAN-COLORS-END
          )
     (mapcar
      (lambda (config)
