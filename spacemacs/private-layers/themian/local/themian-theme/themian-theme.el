...
(defmacro themian-with-color-variables (variant &rest body)
  ...
  `(let* ((class '((class color) (min-colors 89)))
          ...
          (blue     (if dark "#85acf1" "#275483"))
          (green    (if dark "#61bf61" "#278327"))
          (yellow   (if dark "#c8c947" "#838327"))
          (violet   (if dark "#4847c9" "#272783"))
          (orange   (if dark "#bdac42" "#835627"))
          (cyan     (if dark "#47c8c9" "#278383"))
          (magenta  (if dark "#c947c8" "#832783"))
          (red      (if dark "#a93345" "#832754"))

          (diff-1   (if dark "#204040" "#66cccc"))
          (diff-2   (if dark "#306060" "#6cd9d9"))
          (diff-3   (if dark "#102020" "#59b2b2"))
          (diff-4   (if dark "#183030" "#60bfbf"))

          (base-4   (if dark base0     base7))
          (base-3   (if dark base1     base6))
          (base-2   (if dark base2     base5))
          (base-1   (if dark base3     base4))
          (base+1   (if dark base4     base3))
          (base+2   (if dark base5     base2))
          (base+3   (if dark base6     base1))
          (base+4   (if dark base7     base0))
