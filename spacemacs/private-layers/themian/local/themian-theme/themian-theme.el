...
(defmacro themian-with-color-variables (variant &rest body)
  ...
  `(let* ((class '((class color) (min-colors 89)))
          ...
          (magenta  "#ba00da")
          (red      "#da008d")
          (diff-1   (if (eq variant 'dark) "#204040" "#66cccc"))
          (diff-2   (if (eq variant 'dark) "#306060" "#6cd9d9"))
          (diff-3   (if (eq variant 'dark) "#102020" "#59b2b2"))
          (diff-4   (if (eq variant 'dark) "#183030" "#60bfbf"))
          (base-4   (if (eq variant 'dark) base0    base7))
          (base-3   (if (eq variant 'dark) base1    base6))
          (base-2   (if (eq variant 'dark) base2    base5))
          (base-1   (if (eq variant 'dark) base3    base4))
          (base+1   (if (eq variant 'dark) base4    base3))
          (base+2   (if (eq variant 'dark) base5    base2))
