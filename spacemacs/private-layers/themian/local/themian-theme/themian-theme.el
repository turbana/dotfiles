...
(themian-with-color-variables
  (setq themian-faces-list
        `(
          ...
          (evil-ex-info (:background ,unknown))
          (evil-ex-lazy-highlight (:inherit evil-ex-search))
          (evil-ex-search (:background ,grey-4))
          (evil-ex-substitute-matches (:inherit evil-ex-search))
          (evil-ex-substitute-replacement (:background ,unknown))
          ...
          (isearch (:foreground ,grey-1 :background ,yellow-1))
          (isearch-fail (:foreground ,grey-1 :background ,yellow-1))
          ...
          (magit-reflog-reset (:foreground ,orange-1))
