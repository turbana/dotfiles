  ...
  (apply
   ...
   (themian-with-color-variables
     ...
     `(
       ...
       (org-habit-alert-face (:foreground ,base-3 :background ,yellow))
       (org-habit-alert-future-face (:inherit org-habit-alert-face))
       (org-habit-clear-face (:foreground ,base+3 :background ,diff-4))
       (org-habit-clear-future-face (:inherit org-habit-clear-face))
       (org-habit-overdue-face (:foreground ,base-3 :background ,red))
       (org-habit-overdue-future-face (:inherit org-habit-overdue-face))
       (org-habit-ready-face (:foreground ,base+3 :background ,diff-2))
