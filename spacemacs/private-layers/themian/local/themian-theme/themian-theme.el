...
(themian-with-color-variables
  (setq themian-faces-list
        `(
          ...
          (evil-ex-search (:foreground ,yellow-3 :background ,grey-3))
          ...
          (flycheck-error-list-id-with-explainer (:box (:line-width 1 :style released-button)))
          ...
          (flyspell-duplicate (:inherit flycheck-warning))
          ...
          (linum (:inherit default :foreground ,grey-6)) ; ':inherit default' keeps line numbers from being underlined incorrectly
          ...
          (spacemacs-mode-line-new-version-lighter-success-face (:background ,yellow-1 :box (:line-width -1 :color "#0000ff" :style released-button)))
          (spacemacs-mode-line-new-version-lighter-warning-face (:background ,orange-1))
